...
Widget buildStarRating(
  ...
  while (stars.length < 5) {
    stars.add(
      Icon(Icons.star_border, size: iconSize, color: Color(0xFFEBB210)),
    );
  }

  // Add spacing and total ratings text
  stars.add(SizedBox(width: 5));
  if (totalRatings != null && textSize != null) {
    stars.add(
      Text(
  ...
  return Row(crossAxisAlignment: CrossAxisAlignment.center, children: stars);
}
